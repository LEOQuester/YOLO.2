...
class Material():
    ...
    def get_songs(self, keywords, media_type):
        ...
        try:
            ...
            boosted_items = self.get_boosted_songs(formatted_songs)
            if boosted_items:
            # Place boosted items at the top of the list
                boosted_songs = [song for song in formatted_songs if song in boosted_items]
                remaining_songs = [song for song in formatted_songs if song not in boosted_items]
                formatted_songs = boosted_songs + remaining_songs
                print("boosted: "+ boosted_songs)
                print("remaining: "+ remaining_songs)
